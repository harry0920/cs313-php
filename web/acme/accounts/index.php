    ...
    case 'loggedIn':
        ...
        if (count($clientReviews) > 0) {
            ...
            foreach ($clientReviews as $review) 
            {
                ...
                $clientReviewsTable .= "<a href='/acme/reviews/index.php?action=edit-review&reviewId=$review[reviewId]' title='Click to modify'>Edit</a>";
                $clientReviewsTable .= " | <a href='/acme/reviews/index.php?action=delete&reviewId=$review[reviewId]' title='Click to modify'>Delete</a>";
                $clientReviewsTable .= "</li>";
            }
