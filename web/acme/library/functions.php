...
function navigation($categories) {
    ...
    foreach ($categories as $category) {
        ...
        $navList .= "<li>"
                . "<a href='/acme/products/index.php?"
...
function getLoginStatus() {
    ...
    if ($_SESSION['loggedin']) {
        $accountStatus .= "<a href='/acme/accounts/index.php?action=Logout'>Logout</a>";
    } else {
        $accountStatus .= "<a href='/acme/accounts/index.php?action=login'>My Account</a>";
    }
...
function buildProductDetail($productDetails) {
    ...
    foreach ($productDetails as $productDetail) {
        ...
        $pd .= "<li>";
        $pd .= "<img src='$productDetail[invImage]' alt='Image of $productDetail[invName] on Acme.com'>";
...
{
    $reviewForm = "<hr><form action='/acme/reviews/index.php?action=add-review' method='post'>";
