...
switch ($action) {
    ...
    case 'addproduct':
        ...
        // Validate data
        if (empty($inventoryName) || empty($inventoryDescription) || empty($inventoryImage) || empty($inventoryThumbnail) || empty($inventoryVendor) || empty($inventoryStyle) || empty($inventoryLocation)) {
            $message = '<P>Please provide information for all empty form fields.</P>';
            include '../view/new-product.php';
            exit;
        }

        $productOutcome = addProduct($inventoryName, $inventoryDescription, $inventoryImage, $inventoryThumbnail, $inventoryLocation, $categoryId, $inventoryVendor, $inventoryStyle, $inventoryPrice, $inventoryStock, $inventorySize, $inventoryWeight);
        if ($productOutcome === 1) {
    ...
    case 'updateProd':
        ...
        $updateResult = updateProduct($inventoryName, $inventoryDescription, $inventoryImage, $inventoryThumbnail, $inventoryLocation, $categoryId, $inventoryVendor, $inventoryStyle, $inventoryPrice, $inventoryStock, $inventorySize, $inventoryWeight, $prodId);
